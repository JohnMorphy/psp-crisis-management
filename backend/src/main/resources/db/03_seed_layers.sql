...
VALUES
  ('L-01', 'Jednostki ochrony ludnosci', 'EntityLayer',        'Point',        TRUE,  '/api/layers/L-01', 900,  '#2563EB', 'building', 'Krajowa warstwa podmiotow ochrony ludnosci z rejestru aplikacyjnego', TRUE),
